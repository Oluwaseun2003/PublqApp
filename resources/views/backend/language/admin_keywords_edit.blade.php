...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Edit Admin & Organizers Language Keywords') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('Admin & Organizers Language Keywords') }}</a>
            </li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="languageKeywordForm"
                                action="{{ route('admin.update_admin_keywords') }}"
                                method="post">
                                @csrf
                                <div class="row">
